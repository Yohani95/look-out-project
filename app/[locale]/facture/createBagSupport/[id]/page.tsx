...
import { GetAllEntitiesByIdSoporte, getFacturaPeriodoByIdHoras} from "@/app/api/actions/factura/FacturaPeriodoActions";
...
async function page({params}) {
  ...
  const facturas=await GetAllEntitiesByIdSoporte(params.id) as FacturaPeriodo[];
  ...
  return (
    <>
      <BasePages title={t.Nav.facture.requestBilling} >
        <FactureCreate t={t} periodo={data} facturas={facturas} />
      </BasePages>
    </>
  );
}
