            ...
            <div>
                <div className="mb-3 row align-items-center">
                    ...
                    <div className="col-sm-2">
                        <input
                            type="number"
                            className={`form-control ${formik.touched.horas && formik.errors.horas ? 'is-invalid' : ''}`}
                            id="horas"
                            name="horas"
                            min="0"
                            max="999"
                            value={formik.values.horas ?? ""}
                            onChange={(e) => { formik.setFieldValue("horas", e.target.value) }}
                        />
                    ...
                    <div className="col-sm-4">
                        <input className="form-control" type="file" id="file" name="file" onChange={async (event) => {
                        ...
                        {formik.values.nombreDocumento &&
                            <a href={`data:application/octet-stream;base64,${formik.values.contenidoDocumento}`} download={formik.values.nombreDocumento}>
