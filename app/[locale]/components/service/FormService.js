  ...
  return (
    ...
    <div className="mt-3">
      <fieldset disabled>
        <div className="mb-3 row align-items-center">
          ...
          <div className="col-sm-3">
            <input type="text" className="form-control" id="accountName" disabled/>
          </div>
        ...
        <div className=" mb-3 row align-items-center">
          ...
          <div className="col-sm-5">
            <input type="text" className="form-control" id="business_name" disabled/>
          </div>
        </div>
        ...
        <div className=" mb-3 row align-items-center">
          ...
          <label htmlFor="proposal" className="col-sm-1 col-form-label">
            {t("Common.proposal")} {t("Common.accepted", { sex: "a" })}
          </label>
          <div className="col-sm-2">
            <input
              type="text"
      ...
      <div className="mb-3 row align-items-center">
        ...
        <div className="col-sm-2">
          <input type="text" className="form-control" id="estimatedTerm" disabled/>
        </div>
        <div className="col-sm-2">
        ...
        <label htmlFor="estimatedClosingDate" className="col-sm-1 col-form-label">
