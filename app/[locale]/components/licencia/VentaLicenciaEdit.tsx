...
import { createVentaLicencia, updateVentaLicencia } from '@/app/actions/licencia/VentaLicenciaActions';
  ...
  const formik = useFormik({
      ...
      onSubmit: async (values, { setSubmitting }) => {
          try {
              ...
              await updateVentaLicencia(values,data.ventaLicencia.id).then((res) => {
                  router.refresh();
                  if(res != 204){
                      NotificationSweet({
